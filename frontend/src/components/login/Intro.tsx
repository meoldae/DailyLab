...
const characters: characterList = {
    char1: {
        imgsrc: 'src/resources/img/character/coco_clothes_2.png',
        name: '연구소장 코코',
    ...
    char2: {
        imgsrc: 'src/resources/img/character/ian_2.png',
        name: '할일담당 이안',
    ...
    char3: {
        imgsrc: 'src/resources/img/character/diego_2.png',
        name: '일기담당 디에고',
    ...
    char4: {
        imgsrc: 'src/resources/img/character/marco_2.png',
        name: '분석담당 마르코',
    ...
    char5: {
        imgsrc: 'src/resources/img/character/cloe_2.png',
        name: '감정담당 클로에',
...
const Intro = () => {
    ...
    return (
        <div className="pb-8">
            <div className='my-12 text-center text-3xl font-extrabold'>
                연구원들을 소개합니다
            </div>
