...
const ReportTutorial = () => {
    return(
        <>
            ...
            <div className="bg_contents_con p-[20px] h-[50vh] pt-[30px] overflow-hidden flex justify-center"> 
            ...
            <div className="flex text-center items-center">
                ...
                <span className="mt-[20px] text-2xl !font-light"><span className="text-blue">하루 마무리</span> 버튼을 누르면<br/>일정 시간이 지난 후<br/>연구 보고서를 확인할 수 있어요!</span>
            </div>
        </>
    )
}
