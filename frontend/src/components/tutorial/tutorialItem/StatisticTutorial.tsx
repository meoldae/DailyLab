    ...
    return(
        <>
            ...
            <div className="bg_contents_con p-[20px] h-[50vh] flex items-center">
                <img className="w-[280px] m-auto" src={GetMode() === 'dark' ? "./assets/img/tutorial/statistic_dark.png" : "./assets/img/tutorial/statistic_light.png"} alt="" />
            </div>
            {/* 설명 부분 */}
            <div className="flex text-center items-center">
                <img className="w-[150px] -mt-[20px] -mr-[30px]" src={cocoImg} alt="" />
                <span className="-mt-[20px] text-2xl !font-semibold">하단의 통계 아이콘을 눌러<br/>월간, 주간 보고서를 확인해요</span>
            </div>
        </>
    )
}
