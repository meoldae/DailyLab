...
export default function Footer() {
    ...
    return (
        <footer className="z-[2] w-full flex justify-between overflow-hidden fixed left-0 bottom-0 rounded-t-[30px] px-[23px] py-[15px] bg-primary child-[a]:inline-block child-[a]:bg-cover child-[a]:w-[40px] child-[a]:h-[40px] child-[a]:text-0 ">
